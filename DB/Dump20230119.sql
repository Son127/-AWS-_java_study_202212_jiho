CREATE DATABASE  IF NOT EXISTS `db_study_explain` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `db_study_explain`;
-- MySQL dump 10.13  Distrib 8.0.32, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: db_study_explain
-- ------------------------------------------------------
...
--
-- Table structure for table `cousre_mst`
--

DROP TABLE IF EXISTS `cousre_mst`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cousre_mst` (
...
--
-- Dumping data for table `cousre_mst`
--

LOCK TABLES `cousre_mst` WRITE;
/*!40000 ALTER TABLE `cousre_mst` DISABLE KEYS */;
INSERT INTO `cousre_mst` VALUES (1,1,1,1,1),(2,2,1,1,1),(3,3,2,2,1),(4,2,3,3,2);
/*!40000 ALTER TABLE `cousre_mst` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `mentor_mst` VALUES (1,'문자영'),(2,'김소빈');
...
--
-- Dumping events for database 'db_study_explain'
--

--
-- Dumping routines for database 'db_study_explain'
--
